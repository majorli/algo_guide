...
综上所述，当玩具小人的朝向值和某条指令的方向值相等时，沿反方向走；二者不想等时，沿正方向走。从当前玩具小人的实际下标值出发，反方向走多少步就是减去多少，正方向走多少步就是加上多少，然后把新得到虚拟下标值转换为真正的数组下标，就走到了这条指令的目的地，也就是下一条指令的出发点，于是直接继续下一条指令即可，直到所有指令处理完，就得到了解。第一条指令的起点，根据题意，就是数组中的 0 号玩具小人。
