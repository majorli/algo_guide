...
算法设计的方法有许许多多，根据算法界的第一神书《算法导论》，可以分为五种基本类型：:strong:`贪心法`、:strong:`分治法`、:strong:`动态规划法`、:strong:`回溯法`\ 和\ :strong:`分支限界法`，常被尊称为“五大算法”。算法设计方法不同于我们在前面学过的前缀和、差分法、递归、二分法、深搜、宽搜等具体的算法技巧，而是设计算法的思路和方法。
